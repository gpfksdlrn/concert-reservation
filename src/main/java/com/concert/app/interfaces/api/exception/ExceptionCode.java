...
public enum ExceptionCode {
    ...
    E403("403", "접근할 수 없습니다.", HttpStatus.BAD_REQUEST),
    E404("404", "데이터를 조회할 수 없습니다.", HttpStatus.BAD_REQUEST),
    E500("500", "알 수 없는 문제가 발생했습니다. 관리자에게 문의 부탁드립니다.", HttpStatus.BAD_REQUEST);
